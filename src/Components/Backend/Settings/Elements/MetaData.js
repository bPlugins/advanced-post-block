...
const MetaData = ({ attributes, setAttributes, taxOfPostType, updateObj }) => {
	...
	return <PanelBody className='bPlPanelBody' title={__('Meta Data', 'advanced-post-block')} initialOpen={false}>
		...
		<Notice status='premium' isIcon={true}>{__('Custom separators, item gaps, and drag-and-drop sorting are available in the Premium version.', 'advanced-post-block')}</Notice>
	</PanelBody>
}
