	...
	return {
		...
		changelogs: [
			...
			},
			{
				...
				type: 'new',
				list: [
					'Add: Infinite Scroll - Auto-load posts as users scroll down.',
					'Add: Navigation Pagination - Add next/previous buttons for manual browsing.',
					'Add: Load More Button - On-demand post loading with a clickable button.'
				]
			},
			{
